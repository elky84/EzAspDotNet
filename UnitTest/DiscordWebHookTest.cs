...
namespace UnitTest
{
    public class DiscordWebHookTest
    {
                ...
                new DiscordWebHook
                {
                    ...
                    Embeds = new()
                    {
                        new DiscordWebHook.Embed
                        {
                            ...
                            TimeStamp = DateTime.Now.ToUniversalIso8601()
                        }
                    }
                });
        }
        ...
        [Test]
        public async Task EmptyEmbedTime()
        {
            HttpClient httpClient = new();
            ...
            var response = await httpClient.Request<string>(HttpMethod.Post, "https://discord.com/api/webhooks/757093882747158622/m2mrsgUWaPIzi8K7DjuRTLmUZet5VuNllhKRkekhcx_MSNHSRTdmuSISq67HlwN1ehJ6",
                new DiscordWebHook
                {
                    ...
                    Embeds = new()
                    {
                        ...
                        new DiscordWebHook.Embed
                        {
                            Image = new DiscordWebHook.EmbedImage
                            {
                                Url = "https://platform.slack-edge.com/img/default_application_icon.png"
                            }
                        }
                    }
                });
